#!/usr/bin/env bash
# Double-click this file in Finder (macOS) to install the Local First Workbench skill
# for the current user. It just runs install.sh from its own folder.
#
# Destination is ~/.agents/skills/goosnav-local-first-workbench, which both
