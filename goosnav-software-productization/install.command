#!/usr/bin/env bash
# Double-click this file in Finder (macOS) to install the Software Productization skill
# for the current user. It just runs install.sh from its own folder.
#
# Destination is ~/.agents/skills/goosnav-software-productization, which both
